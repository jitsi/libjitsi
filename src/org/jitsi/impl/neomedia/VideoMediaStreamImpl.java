    ...
    implements VideoMediaStream
{
    ...
    public boolean isKeyFrame(byte[] buf, int off, int len)
    {
        ...
        try {
            ...
            {
                // XXX There's RawPacket#getPayloadLength() but the
                // implementation includes pkt.paddingSize at the time of this
                // writing and we do not know whether that's going to stay that
                // way
