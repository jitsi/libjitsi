...
/**
 * Implements an AWT <tt>Component</tt> in which <tt>HWRenderer</tt> paints.
 *
 * @author Sebastien Vincent
 */
public class HWRendererVideoComponent
    extends AbstractAWTRendererVideoComponent
{
    /**
     * The serial version UID of the <tt>HWRendererVideoComponent</tt> class
     * defined to silence a serialization compile-time warning.
     */
    private static final long serialVersionUID = 0L;

    /**
     * Initializes a new <tt>HWRendererVideoComponent</tt> instance.
     *
     * @param renderer
     */
    public HWRendererVideoComponent(HWRenderer renderer)
    {
        super(renderer);
    }
    ...
    {
        return HWRenderer.paint(handle, component, g, zOrder);
    }
}
