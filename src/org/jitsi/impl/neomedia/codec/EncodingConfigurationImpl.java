...
public class EncodingConfigurationImpl extends EncodingConfiguration
{
    ...
    private void initializeFormatPreferences()
    {
        ...
        */
        ...
        setEncodingPreference(Constants.SPEEX, 32000, 701);
        setEncodingPreference(Constants.SPEEX, 16000, 700);
        ...
        setEncodingPreference(Constants.SPEEX, 8000, 352);
        ...
        setEncodingPreference(Constants.G729, 8000, 0 /* proprietary */);
